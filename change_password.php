...
<?php
$query=mysqli_query($con,"select * from students where student_id='$session_id'")or die(mysqli_error());
    ...
    <div class="container">
		<div class="margin-top">
			...
			<?php
						...
						mysqli_query($con,"update students set password = '$np' where student_id = '$session_id' ")or die(mysqli_error); ?>

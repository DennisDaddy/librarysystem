...
<?php $get_id = $_GET['id']; ?>
    <div class="container">
		<div class="margin-top">
			...
			<div class="span12">	
		<?php 
		$query=mysqli_query($con,"select * from book LEFT JOIN category on category.category_id  = book.category_id where book_id='$get_id'")or die(mysqli_error());
	...
	<form class="form-horizontal" method="POST" action="update_books.php" enctype="multipart/form-data">
		...
		<div class="control-group">
			...
			<select name="category_id">
				...
				<?php $query1 = mysqli_query($con,"select * from category where category_id != '$category_id'")or die(mysqli_error());

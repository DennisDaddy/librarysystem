...
<div class="span3">
				...
				<option></option>
				<?php $result =  mysqli_query($con,"select * from member")or die(mysqli_error()); 
						...
						<div class="alert alert-success"><strong>Select Book</strong></div>
                            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysqli_query($con,"select * from book where status != 'Archive' ")or die(mysqli_error());
									while($row=mysqli_fetch_array($user_query)){
									$id=$row['book_id'];  
									$cat_id=$row['category_id'];

											$cat_query = mysqli_query($con,"select * from category where category_id = '$cat_id'")or die(mysqli_error());
